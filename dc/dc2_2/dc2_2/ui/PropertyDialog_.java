...
public class PropertyDialog_ extends JDialog {
    ...
    public static void main(String[] args) {
        try {
            PropertyDialog_ dialog = new PropertyDialog_();
            ...
            }
            {
                ...
                }
                {
                    ...
                    btnGoToColorChooser.addActionListener(
                            e -> {
                                fontColorChooser = new JColorChooser(DefaultProperties.FONT_COLOR);
