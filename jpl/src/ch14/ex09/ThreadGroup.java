...
public class ThreadGroup {
    ...
    private void showParentThread(ThreadGroup threadGroup) {
		parentThreadGroup = threadGroup;
        ArrayList<ThreadGroup> parentList = new ArrayList<>();
        /*
    ...
    private void showThreadData(ThreadGroup threadGroup) {
